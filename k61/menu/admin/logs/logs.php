...
<body>
    ...
    <!-----------------------------STRONA--------------------------------------------->
    <div id=strona>
        <div id=header>Logi serwera</div>
        <div id=main>
            <!---------------------TREŚĆ---------------------------->
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">Logi</th>
                    </tr>
                </thead>
                <tbody>

                    <tr>
                        <td>Logi z ostatnich 18 miesięcy</td>
                    </tr>
                </tbody>
                <form method="POST">
                    <tfoot>
                        <tr>
                            <td style="border-color: #f2f2f2; background-color: #f2f2f2;"><button type="submit" name="submit">Pobierz</button></td>
                        </tr>
                    </tfoot>
                </form>
            </table>
