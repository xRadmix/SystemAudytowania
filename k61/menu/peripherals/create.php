...
<body>
    ...
    <!-----------------------------STRONA--------------------------------------------->
    <div id=strona>
        <div id=header>Dodaj peryferia</div>
        <div id=main>
            <!---------------------TREŚĆ---------------------------->
            <header>Dodawanie peryferiów</header>
            <div class="container">
                <h3>Uzupełnij poniższy formularz w celu dodania peryferiów</h3>
            </div>
            <form method="POST">
                <div class="row">
                    <div class="column">
                    ...
                    <div class="column">
                        <label class="form-label">Mysz:</label>
                        <input type="text" name="mysz" value="<?php echo $row['mysz'] ?>">>
                    </div>
                    <div class="column">
                        <label class="form-label">Klawiatura:</label>
