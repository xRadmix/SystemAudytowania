...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `uzytkownicy` SET `imie`='$imie',`nazwisko`='$nazwisko' WHERE id=$id";
    $sql2 = "UPDATE `komputery` SET `imie`='$imie',`nazwisko`='$nazwisko' WHERE id_u=$id";
...
<body>
    ...
    <!-----------------------------STRONA--------------------------------------------->
    <div id=strona>
        <div id=header>Edytuj użytkownika</div>
        <div id=main>
            <!---------------------TREŚĆ---------------------------->
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM `uzytkownicy` WHERE id = $id LIMIT 1";
