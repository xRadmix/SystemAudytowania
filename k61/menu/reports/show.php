...
<body>
    ...
    <div id=menu>
        ...
        <a href=>
            <div class=buttons>
                <div class=info>Generuj</div>
                <div id=side_button><i class="fa fa-download fa-2x"></i></div>
            </div>
        </a>
        ...
        <div id=main>
            ...
            <table class="table">
                ...
                <form method="POST">
                    <tfoot>
                        <tr>
                            <td style="border-color: #f2f2f2; background-color: #f2f2f2;"><button type="submit" name="submit">Generuj raport</button></td>
                        </tr>
                    </tfoot>
                </form>
            </table>
