...
if (isset($_POST['submit'])) {
    ...
    #------------------------------#
    $sql = "INSERT INTO `wyswietlacze`(`imie`, `nazwisko`, `producent`, `model`, `nr_seryjny_w`, `id_u`) 
    VALUES ('$u_name','$u_surname','$producent','$model','$nr_seryjny_w', '$id_u')";
    $u_sql = "UPDATE `uzytkownicy` SET `nr_seryjny_w`='$nr_seryjny_w' WHERE id=$id_u";
    #------------------------------#
...
<body>
    ...
    <!-----------------------------STRONA--------------------------------------------->
    <div id=strona>
        <div id=header>Dodaj wyświetlacz</div>
        <div id=main>
            <!---------------------TREŚĆ---------------------------->
            <header>Dodawanie wyświetlaczy</header>
            <div class="container">
                <h3>Uzupełnij poniższy formularz w celu dodania nowego wyświetlacza</h3>
            </div>
            <form method="POST">
                <div class="row">
                    <div class="column">
                    ...
                    <div class="column">
                        ...
                        <input type="text" name="nr_seryjny_w" value="<?php echo $row['nr_seryjny_w'] ?>">>
                    </div>
                    <div>
